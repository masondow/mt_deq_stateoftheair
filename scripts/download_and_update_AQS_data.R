...
#----------DOWNLOAD AQS DATA-----------
download_and_save_pollutant_data <- function(target_parameters, byear = 2000, state_fips = 30, save_dir = "data/aqs_data/daily_raw") {
...
download_and_save_pollutant_data(target_parameters)
