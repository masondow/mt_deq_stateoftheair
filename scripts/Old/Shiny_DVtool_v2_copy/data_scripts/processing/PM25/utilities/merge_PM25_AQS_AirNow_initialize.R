...
#### WARNING: do not run unless available 3-yr AirNow archive is long enough to extend back to PM25 88502 sites that last reported to AQS in March 2024 (see Seeley Lake)
...
saveRDS(merged, here("data_processed","merged_hourly", "merged_hourly_PM25.rds"))
...
saveRDS(merged, here("data_processed","merged_daily", "merged_daily_PM25.rds"))
