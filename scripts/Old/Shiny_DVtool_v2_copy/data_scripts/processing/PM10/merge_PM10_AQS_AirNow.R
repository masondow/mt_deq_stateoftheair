...
merged_full_record <- readRDS(here("data_processed","merged_hourly", "merged_hourly_PM10.rds"))
...
saveRDS(merged_full_record_updated, here("data_processed","merged_hourly", "merged_hourly_PM10.rds"))
saveRDS(merged_full_record_short, here("data_processed","merged_hourly", "recent_hourly", "merged_short_hourly_PM10.rds"))
...
# Merge updates with full record
merged_full_record <- readRDS(here("data_processed","merged_daily", "merged_daily_PM10.rds")) 
...
saveRDS(merged_full_record_updated, here("data_processed","merged_daily", "merged_daily_PM10.rds"))
