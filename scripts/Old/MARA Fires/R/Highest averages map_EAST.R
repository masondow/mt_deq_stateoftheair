...
ggplot(east_highest_averages, aes(x = longitude, y = latitude, fill = average_arithmetic_mean)) +
  ...
  labs(title = bquote(atop(bold("Eastern Montana Smokiest Days (2003-2023)"), 
